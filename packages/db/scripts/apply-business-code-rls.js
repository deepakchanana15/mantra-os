/**
 * One-off: applies the RLS policy for `daily_business_code_counters`
 * against whatever DATABASE_URL is currently in packages/db/.env — as the
 * owner connection. Same narrow pattern as apply-ad-metrics-rls.js.
 *
 * Usage: node scripts/apply-business-code-rls.js
 */
const fs = require("fs");
